...
[{capture append="oxidBlock_content"}]
    ...
    [{if $oView->getBargainArticleList()|@count > 0 || ($promoCatTitle && $promoCatImg)}]
        <div class="promoBoxes clear">
            <a href="[{$actionproduct->getLink()}]" title="[{$actionproduct->oxarticles__oxtitle->value}]" style="float:left">
                <img src="[{$actionproduct->getMyPictureUrl()}]">
            </a>
            <h2 class="sectionHead" style="float:left;width:360px">[{$actionproduct->oxarticles__oxtitle->value}]</h2>
            <p>
                [{$actionproduct->oxarticles__oxshortdesc->value}]
            </p>
        </div>
        <div class="promoBoxes clear">
