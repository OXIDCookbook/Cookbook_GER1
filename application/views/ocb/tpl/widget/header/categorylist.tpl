...
<ul id="navigation" class="sf-menu">
      ...
      [{if $ocat->getIsVisible() }]
        ...
        [{if $iCatCnt <= $oView->getTopNavigationCatCnt()}]
            <li [{if $homeSelected == 'false' && $ocat->expanded}]class="current"[{/if}]>
                <a  [{if $homeSelected == 'false' && $ocat->expanded}]class="current"[{/if}] href="[{$ocat->getLink()}]">[{if $ocat->getPromotionIconUrl()}]<img src="[{$ocat->getPromotionIconUrl()}]"> [{/if}][{$ocat->oxcategories__oxtitle->value}][{ if $oView->showCategoryArticlesCount() && ($ocat->getNrOfArticles() > 0) }] ([{$ocat->getNrOfArticles()}])[{/if}]</a>
                [{if $ocat->getSubCats()}]
                    <ul>
    ...
    [{/if}]
        ...
        <li [{if $oViewConf->getTopActiveClassName() == "toxid_curl"}]class="current"[{/if}]>
             <a  [{if $oViewConf->getTopActiveClassName() == "toxid_curl"}]class="current"[{/if}] href="[{ $toxid->getToxidStartUrl() }]">Blog</a>
        </li>
</ul>
